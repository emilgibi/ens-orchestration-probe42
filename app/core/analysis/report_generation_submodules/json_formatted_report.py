...
async def format_json_report(data, session):
    ...
    copr_required_cols = ["employee", "name", "location", "address", 'website', 'active_status', 'operation_type',
                          'legal_status', 'pan_id', 'alias', 'incorporation_date', 'revenue',
    ...
    meta_cols=[]
    meta_cols = await get_dynamic_ens_data("upload_supplier_data", upload_meta_cols, ens_id_value,
    ...
    kpi_table_name = ['cyes', 'fstb', 'legal', 'oval', 'rfct', 'sape', 'sown', 'news']  # news
